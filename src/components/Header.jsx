            ...
            >
              ...
              <div className="text-sm flex flex-col">
                <div className="flex items-center justify-between gap-4">
                  <span>Wesly Gatner</span>{" "}
                  <span className="text-[8px]">10/21/2022</span>
                </div>
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            ...
            >
              ...
              <div className="flex flex-col text-sm">
                <span className="text-sm">Wesly Gatner</span>
                <span className="text-xs text-gray-500">wesgatner@hotmail.com</span>
              </div>
            </Link>
          </MenuItem>
